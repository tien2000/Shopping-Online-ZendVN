<?php
    class Tls_Sp_Setting_Validate{
        ...
        public function isValidate($options = array()) {
            ...
            $product_number = $tls_sp_setting['product_number'];
            ...
            $currency_unit = $tls_sp_setting['currency_unit'];
            ...
            /* $payment = $tls_sp_setting['payment'];
            if (!isset($payment)){
            ...
            $alert_to_email = $tls_sp_setting['alert_to_email'];
            ...
            $select_type = $tls_sp_setting['select_type'];
            ...
            $email_address = $tls_sp_setting['email_address'];
            ...
            $from_name = $tls_sp_setting['from_name'];
            ...
            $smtp_host = $tls_sp_setting['smtp_host'];
            ...
            $encription = $tls_sp_setting['encription'];
            if (!isset($encription)){
            ...
            $smpt_port = $tls_sp_setting['smpt_port'];
            ...
            $smtp_auth = $tls_sp_setting['smtp_auth'];
            if (!isset($smtp_auth)){
            ...
            $smtp_username = $tls_sp_setting['smtp_username'];
            ...
            $smtp_password = $tls_sp_setting['smtp_password'];
